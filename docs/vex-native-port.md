...
| MortOS ABI | Stable syscalls for files, memory, time, networking, graphics, input, audio, and entropy | File/memory/time/thread IPC plus fail-closed hardware `getrandom` boot-tested; remaining device APIs in progress |
