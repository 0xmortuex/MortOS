...
| Process runtime | Validating ELF64 ET_EXEC loader, W^X PT_LOAD mappings, demand-paged heap, PID/exit/fault states, cooperative saved contexts | Boot-tested foundation; timer preemption, threads, handles, IPC next |
