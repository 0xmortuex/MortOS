...
| Node/V8 | V8 JIT permissions, libuv event loop, Node filesystem/network/process APIs | JIT memory, pthread/timers/event-loop foundation, and bidirectional Ethernet hardware are boot-tested; sockets and full Node build remain |
