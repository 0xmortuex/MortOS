...
- **Event-driven runtime foundation** — pipes and 64-bit `eventfd2` counters participate in blocking/timed `poll`; ring-3 tests prove cross-thread wakeups rather than only immediate readiness.
