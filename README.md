...
- **POSIX monotonic time** — the bootstrap libc exposes `clock_gettime`, `clock_getres`, `nanosleep`, `clock_nanosleep`, `sleep`, and `usleep` over the interruptible scheduler instead of busy-spinning.
